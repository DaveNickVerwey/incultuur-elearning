      ...
      <div style={{ background: 'white', borderRadius: '16px', padding: '3rem', maxWidth: '520px', width: '100%', boxShadow: '0 4px 24px rgba(0,0,0,0.08)' }}>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
            <div>
              ...
              <input
                ...
                required
                style={{ width: '100%', padding: '0.65rem', border: '1px solid #ddd', borderRadius: '8px', fontSize: '0.95rem', boxSizing: 'border-box' }}
              />
            </div>
            <div>
          ...
          <div style={{ marginBottom: '1.5rem' }}>
            ...
            <textarea
              name="verwachting"
              value={form.verwachting}
              onChange={handleChange}
              rows={3}
              style={{ width: '100%', padding: '0.65rem', border: '1px solid #ddd', borderRadius: '8px', fontSize: '0.95rem', boxSizing: 'border-box', resize: 'vertical' }}
            />
          </div>
